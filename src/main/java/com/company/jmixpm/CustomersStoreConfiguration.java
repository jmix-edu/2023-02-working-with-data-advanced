...
public class CustomersStoreConfiguration {
    ...
    @Bean
    public SpringLiquibase customersLiquibase(LiquibaseChangeLogProcessor processor, @Qualifier("customersDataSource") DataSource dataSource) {
        return JmixLiquibaseCreator.create(dataSource, new LiquibaseProperties(), processor, "customers");
    }
}
